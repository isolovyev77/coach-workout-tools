...
but do not stop the import.`,
  ...
  trenda-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  trenda-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | trenda-pp-cli import <resource> --input -`,
