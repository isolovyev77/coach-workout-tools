...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "trenda-pp-cli",
		Short: "Manage trenda resources via the trenda API",
		Long: `Manage trenda resources via the trenda API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'trenda-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("trenda-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'trenda-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCoachCmd(flags))
