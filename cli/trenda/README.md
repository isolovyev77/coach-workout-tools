...
Авторизация - сессионные cookie, выдаваемые при входе коуча. При ответе 401
CLI вызывает внутренний refresh-маршрут, сохраняет выданные cookie и повторяет
исходный запрос один раз — пароль для этого не нужен.
