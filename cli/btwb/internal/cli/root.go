...
func Execute() error {
	...
	// main() already prints the error and picks the exit code; without this
	// Cobra prints it too and every failure is reported twice.
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "btwb-pp-cli",
		Short: "Manage btwb resources via the btwb API",
		Long: `Manage btwb resources via the btwb API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'btwb-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("btwb-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'btwb-pp-cli profile list')")
	...
	rootCmd.AddCommand(newWodCmd(flags))
	rootCmd.AddCommand(newMembersCmd(flags))
	rootCmd.AddCommand(newWebwidgetsCmd(flags))
