...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cap-pp-cli",
		Short: "Manage cap resources via the cap API",
		Long: `Manage cap resources via the cap API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'cap-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cap-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cap-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCapCmd(flags))
